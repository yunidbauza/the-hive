 ...
 * click had answered. A ticket names no project at all: a Jira issue has no idea
 * which of the user's repositories it will be worked in, and the same issue can
 * legitimately be worked in two. So the click here *is* a question, and the
 * picker is where it gets asked — along with model and thinking effort, which
 * the user may well want to set differently for a ticket than for a scratch
 * session.
 *
