...
Today that is **shipper**, the PR endgame, and **acr**, the reviewer it asks; the rest of
the workflow agents land as they ship. Your edits win: a definition you changed is left
